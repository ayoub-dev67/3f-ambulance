...
export const metadata = generatePageMetadata({
  title: "Contact & Réservation | 3F Ambulance Alsace",
  description: "Réservez votre transport médical : ambulance, VSL, taxi conventionné. Disponible 24h/24 en Alsace et longue distance. Appelez le 06 33 81 40 47.",
  path: "/contact",
});
    ...
    <>
      ...
      <section className="bg-primary py-14 md:py-16">
        <div className="container-custom text-center">
          <h1 className="font-heading text-3xl font-bold text-white md:text-4xl">Contactez 3F Ambulance</h1>
          <p className="mx-auto mt-4 max-w-xl text-blue-100/80 leading-relaxed">Réservez votre transport médical. Disponibles 24h/24 en Alsace et longue distance.</p>
        </div>
      </section>
