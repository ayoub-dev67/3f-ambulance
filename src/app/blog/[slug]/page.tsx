...
import { CATEGORY_COLORS, formatDate } from "@/lib/blog-utils";
  ...
  return (
    <>
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        ...(article.image ? { image: `https://3f-ambulance.vercel.app${article.image}` } : {}),
        author: { "@type": "Organization", name: "3F Ambulance" },
        publisher: { "@type": "Organization", name: "3F Ambulance" },
      }) }} />
      <BreadcrumbJsonLd items={[
        { name: "Accueil", url: "https://3f-ambulance.vercel.app" },
        { name: "Blog", url: "https://3f-ambulance.vercel.app/blog" },
        { name: article.title, url: `https://3f-ambulance.vercel.app/blog/${article.slug}` },
      ]} />
    </>
  );
}
