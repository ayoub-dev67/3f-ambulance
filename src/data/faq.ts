...
export const faqItems: FAQItem[] = [
  {
    question: "Comment réserver un transport médical avec 3F Ambulance ?",
    answer: "C'est simple, en 3 étapes : 1) Demandez une prescription médicale de transport à votre médecin (le volet 4 du cerfa). 2) Appelez-nous au 06 33 81 40 47 ou remplissez notre formulaire en ligne — nous sommes joignables 24h/24. 3) Nous confirmons l'horaire de prise en charge et nos ambulanciers viennent vous chercher à l'adresse convenue.",
  },
  {
  ...
  },
  {
    ...
    answer: "C'est le document obligatoire pour que votre transport soit remboursé. Votre médecin le remplit sur le formulaire cerfa (volet 4) en précisant : le mode de transport nécessaire (ambulance, VSL ou taxi), la raison médicale du déplacement, et la destination. Sans ce document, le transport ne peut pas être pris en charge par l'Assurance Maladie. Pensez à le demander AVANT votre transport.",
  },
  {
  ...
  },
  {
    ...
    answer: "Nos ambulanciers arrivent à l'heure convenue avec le matériel adapté. Ils vous aident à vous installer confortablement sur le brancard, vérifient vos constantes si nécessaire, et assurent votre surveillance tout au long du trajet. À l'arrivée à l'hôpital, ils vous accompagnent jusqu'au service concerné et transmettent votre dossier au personnel soignant. Pour le retour, c'est le même principe : ils viennent vous chercher dans le service et vous raccompagnent chez vous.",
  },
  {
    question: "Combien coûte un transport en ambulance ?",
    answer: "Le tarif dépend du type de véhicule (ambulance, VSL, taxi) et de la distance parcourue. Mais dans la grande majorité des cas, vous n'avez rien ou presque rien à payer : avec une prescription médicale, la Sécurité sociale prend en charge 65% à 100% du tarif conventionné, et votre mutuelle couvre généralement le reste. Nous pratiquons le tiers payant, donc pas d'avance de frais dans la plupart des situations. Appelez-nous pour un devis précis.",
  },
  {
